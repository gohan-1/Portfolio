  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[60vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-800 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] p-5 md:w-[40vw] md:p-16 py-6 dark:border-zinc-700 dark:bg-[linear-gradient(180deg,#27272a,#18181b)]"
